...
namespace PlayUR
{
    public partial class PlayURPlugin : UnitySingletonPersistent<PlayURPlugin>
    {
        ...
        public string mTurkFromStandaloneLoginInfo = null; //if in a standalone build, we can get the mTurkID from the login info (api/Configuration/index.php returns this)
